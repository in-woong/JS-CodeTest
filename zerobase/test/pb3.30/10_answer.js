...
function romanNumDocs() {
  ...
  for (let tokenIndex = 0; tokenIndex < TOKENS.length; tokenIndex++) {
    ...
    for (
      let generalizationIndex = 0;
      generalizationIndex < GENERALIZATION_INDICES.length;
      generalizationIndex++
    ) {
...
const input = ['XXVI', 'III', 'LVIII', 'MCMXCIV', 'MMMCMXCIX', 'MDCLXVI'];
